...
const CallTrackerForm = ({ 
  ...
  const [scMasterData, setScMasterData] = useState([]) // Added to store SC mapping
  ...
  const [newCallTrackerData, setNewCallTrackerData] = useState({
    ...
    gstNumber: "",
    isCompanyAutoFilled: !!initialCompanyName // Added to track auto-fill status
  })
  ...
  const [isCompanyAutoFilled, setIsCompanyAutoFilled] = useState(!!initialCompanyName);
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  const matchedSc = scMasterData.find(sc => sc.sourceName.toLowerCase() === source.toLowerCase());
                  setNewCallTrackerData({ 
                    ...newCallTrackerData, 
                    leadSource: source,
                    scName: matchedSc ? matchedSc.personName : ""
                  });
                }}
                required
              >
